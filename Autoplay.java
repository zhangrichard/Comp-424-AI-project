...
public class Autoplay
{
    ...
    public static void main(String args[])
    {
        ...
        String server_line = "java -cp ../jar/omweso.jar boardgame.Server -ng -k";

        System.out.println("Working Directory = " +
                System.getProperty("user.dir"));

        try {
            Process server = rt.exec(server_line);

            for (int i=0; i<NUM_OF_GAMES; i++) {
                System.out.println("Game "+i);

                String client1_line = "java -cp ../jar/omweso.jar:../aiplayer/src boardgame.Client s260560802.s260560802Player localhost 8123";
