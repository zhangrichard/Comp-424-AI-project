...
public class Autoplay3
{
	
	public final static int NUM_OF_GAMES = 5;
    ...
    public static void main(String args[])
    {
        ...
        try {
            ...
            for (int i=0; i<NUM_OF_GAMES; i++) {
                ...
                String client2_line = "java -cp ../jar/omweso.jar:./src boardgame.Client s260560802.s260560802Player";
